...
Если вы видите `Найдено столбцов: 0`, это может означать:
1. Неверные настройки подключения к ClickHouse (проверьте хост, порт, пользователя, пароль)
2. Таблица не существует в указанной базе данных
3. У пользователя нет прав на чтение структуры таблицы
